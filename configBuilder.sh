...
# script config items
SHB_CFG_URL=https://github.com/bekkaoui99/shibboleth-idp-config/archive/main.zip
TOM_CFG_URL=https://github.com/bekkaoui99/shibboleth-idp-tomcat-config/archive/main.zip
TMP_DIR_S=/tmp/shibboleth-idp-config-main
...
################################################################################
#
cp -rf ${TMP_DIR_S}/shibboleth-idp-config-main/conf/idp.properties ${SHBCFG}
cp -rf ${TMP_DIR_S}/shibboleth-idp-config-main/conf/ldap.properties ${SHBCFG}
cp -rf ${TMP_DIR_S}/shibboleth-idp-config-main/conf/metadata-providers.xml ${SHBCFG}
cp -rf ${TMP_DIR_S}/shibboleth-idp-config-main/conf/attribute-resolver.xml ${SHBCFG}
cp -rf ${TMP_DIR_S}/shibboleth-idp-config-main/conf/attribute-filter.xml ${SHBCFG}
cp -rf ${TMP_DIR_S}/shibboleth-idp-config-main/conf/logback.xml ${SHBCFG}
cp -rf ${TMP_DIR_S}/shibboleth-idp-config-main/views/* ${SHBVIEWS}
cp -rf ${TMP_DIR_S}/shibboleth-idp-config-main/credentials/inc-md-cert-mdq.pem ${SHBCREDS}
cp -rf ${TMP_DIR_S}/shibboleth-idp-config-main/credentials/sealer.kver ${SHBCREDS}
cp -rf ${TMP_DIR_T}/shibboleth-idp-tomcat-config-main/conf/* ${TOMCFG}
cp -rf ${TMP_DIR_T}/shibboleth-idp-tomcat-config-main/wwwroot/* ${TOMWWWROOT}
